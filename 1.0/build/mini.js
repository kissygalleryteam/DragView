...
gallery/DragView/1.0/index
gallery/DragView/1.0/mini
 ...
 * @module dragview
 **/
KISSY.add('gallery/DragView/1.0/index',function(S, Node, IO, Uri, DS){
    var $ = Node.all;
    ...
    requires: ["node", "io", "uri", "gallery/DragSwitch/1.0/"]
});
/**
 * @fileoverview 
 * @author 筱谷<xiaogu.gxb@taobao.com>
 * @module dragview
 **/
KISSY.add('gallery/DragView/1.0/mini',function (S, DragView) {
    return DragView;
}, {requires:["./index"]});
